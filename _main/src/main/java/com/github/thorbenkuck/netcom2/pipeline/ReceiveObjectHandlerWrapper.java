...
class ReceiveObjectHandlerWrapper {
	...
	private final com.github.thorbenkuck.netcom2.pipeline.ReflectionBasedObjectAnalyzer reflectionBasedObjectAnalyzer;

	@APILevel
	ReceiveObjectHandlerWrapper() {
		reflectionBasedObjectAnalyzer = new com.github.thorbenkuck.netcom2.pipeline.ReflectionBasedObjectAnalyzer();
	}
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof com.github.thorbenkuck.netcom2.pipeline.ReceiveObjectHandlerWrapper)) return false;

		final com.github.thorbenkuck.netcom2.pipeline.ReceiveObjectHandlerWrapper that = (com.github.thorbenkuck.netcom2.pipeline.ReceiveObjectHandlerWrapper) o;
