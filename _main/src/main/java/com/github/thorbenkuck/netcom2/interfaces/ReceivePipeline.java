...
public interface ReceivePipeline<T> extends Mutex {
     ...
     * is executed upon calling the {@link #run(ConnectionContext, Session, Object)}.
     * <p>
     ...
     * @return a {@link ReceivePipelineCondition}, to describe whether or not the pipelineService is executed upon calling {@link #run(ConnectionContext, Session, Object)}
     */
     ...
     * @return an {@link ReceivePipelineCondition}, to describe whether or not the pipelineService is executed upon calling {@link #run(ConnectionContext, Session, Object)}
