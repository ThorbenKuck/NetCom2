...
public interface CommunicationRegistration extends Mutex {
	 ...
	 * <p>
	 * All it does, is to call {@link #trigger(Class, ConnectionContext, Session, Object)}, with the direct Class of the provided
	 * Object
	 * <p>
	 ...
	 *
	 * @param connectionContext the {@link ConnectionContext} over which the Object was received
	 ...
	 * @see #trigger(Class, ConnectionContext, Session, Object)
	 */
