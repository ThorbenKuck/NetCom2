...
public interface DecryptionAdapter extends Adapter<String, String> {
	...
	/**
	 * Creates a default DecryptionAdapter. The call of this Method is to be preferred over using whatever is stated
	 * inside this method. Therefore, only this Method has to be changed, if the default behavior changes
	 *
