...
/**
 * This Class handles any received {@link NewConnectionRequest} over the Network
 *
 * @version 1.0
 * @since 1.0
 */
@APILevel
@Synchronized
@Tested(responsibleTest = "com.github.thorbenkuck.netcom2.network.server.NewConnectionRequestHandlerTest")
