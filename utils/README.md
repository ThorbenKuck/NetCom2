...
NetCom2-Util is a very small, very simple module. It provides the base Exception types, one Mutex interface as well as a Utility class.
...
1.0 Release within extensive module separation
 ...
 ```
 dependencies {
     compile group: 'com.github.thorbenkuck', name: 'NetCom2-Util', version: '1.0'
 }
 ```
